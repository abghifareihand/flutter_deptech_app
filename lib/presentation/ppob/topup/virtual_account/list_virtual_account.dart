...
import 'package:rekalaba/screens/ppob/topup/virtual_account/topup_virtual_account.dart';
...
class ListVirtualAccount extends StatelessWidget {
        ...
        children: <Widget>[
          ...
          ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              final VirtualAccountModel virtualAccount = virtualAccountList[index];
              return InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    RekaRoute<dynamic>(
                      builder: (BuildContext context) => TopupVirtualAccount(virtualAccount: virtualAccount),
                    ),
                  );
                },
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Expanded(
                        flex: 12,
                        child: Text(
                          virtualAccountList[index].bankName,
