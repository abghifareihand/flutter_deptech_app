...
class PaketDataInputNumber extends StatefulWidget {
  const PaketDataInputNumber({Key? key}) : super(key: key);

  @override
  State<PaketDataInputNumber> createState() => _PaketDataInputNumberState();
}

class _PaketDataInputNumberState extends State<PaketDataInputNumber> {
              ...
              onPressed: isDisabled
                  ...
                  : () {
                      Navigator.push(
                        context,
                        RekaRoute<dynamic>(
                          builder: (BuildContext context) => PaketDataSelectNominal(
