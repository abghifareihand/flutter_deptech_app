...
class PaketDataConfirmation extends StatelessWidget {
  const PaketDataConfirmation({Key? key}) : super(key: key);
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Text(
                    'Telkomsel Data 15GB 30Hari PROMO',
                    style: RekaTextStylesV2.textSm.regular.copyWith(
                      color: RekaColorsV2.darkNight,
                    ),
                    textAlign: TextAlign.right,
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Text(
                    'Rp ${FormatterService.getPriceFormatInt(65000)}',
                    style: RekaTextStylesV2.textSm.regular.copyWith(
                      color: RekaColorsV2.darkNight,
                    ),
                    textAlign: TextAlign.right,
