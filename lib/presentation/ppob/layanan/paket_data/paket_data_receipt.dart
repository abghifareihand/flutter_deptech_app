...
class PaketDataReceipt extends StatelessWidget {
  const PaketDataReceipt({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              _detailReciept('Deskripsi', 'Telkomsel Data 15GB 30Hari PROMO'),
