...
class PaketDataSelectNominal extends StatefulWidget {
  const PaketDataSelectNominal({
    Key? key,
  ...
  @override
  State<PaketDataSelectNominal> createState() => _PaketDataSelectNominalState();
}

class _PaketDataSelectNominalState extends State<PaketDataSelectNominal> {
  final TextEditingController _numberController = TextEditingController();

  // Data dummy untuk nominal pulsa
  final List<Map<String, dynamic>> _listPulsa = <Map<String, dynamic>>[
    <String, dynamic>{
      'provider': 'DATA FLASH 1GB',
      'nominal': 2000,
      'price': 2800,
      'isSold': false,
    },
    <String, dynamic>{
      'provider': 'DATA FLASH 10GB',
      'nominal': 3000,
      'price': 3800,
      'isSold': false,
    },
    <String, dynamic>{
      'provider': 'TELKOMSEL 15GB',
      'nominal': 5000,
      'price': 5800,
      'isSold': false,
    },
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    RekaRoute<dynamic>(
                      builder: (BuildContext context) => const PaketDataConfirmation(),
                    ),
                  );
                },
                child: Container(
