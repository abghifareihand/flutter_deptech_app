...
import 'package:rekalaba/screens/ppob/layanan/paket_data/paket_data_confirmation.dart';
import 'package:rekalaba/screens/ppob/layanan/paket_sms/paket_sms_confirmation.dart';
...
class PaketSmsSelectNominal extends StatefulWidget {
  const PaketSmsSelectNominal({
    Key? key,
  ...
  @override
  State<PaketSmsSelectNominal> createState() => _PaketSmsSelectNominalState();
}

class _PaketSmsSelectNominalState extends State<PaketSmsSelectNominal> {
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    RekaRoute<dynamic>(
                      builder: (BuildContext context) => const PaketSmsConfirmation(),
                    ),
                  );
                },
                child: Container(
