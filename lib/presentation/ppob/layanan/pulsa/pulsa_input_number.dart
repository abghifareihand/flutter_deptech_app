...
import 'package:rekalaba/screens/ppob/layanan/pulsa/pulsa_select_nominal.dart';
...
class PulsaInputNumber extends StatefulWidget {
  const PulsaInputNumber({Key? key}) : super(key: key);

  @override
  State<PulsaInputNumber> createState() => _PulsaInputNumberState();
}

class _PulsaInputNumberState extends State<PulsaInputNumber> {
              ...
              onPressed: isDisabled
                  ...
                  : () {
                      Navigator.push(
                        context,
                        RekaRoute<dynamic>(
                          builder: (BuildContext context) => PulsaSelectNominal(
