...
class PulsaReceipt extends StatelessWidget {
  const PulsaReceipt({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              _detailReciept('Layanan', 'Pulsa'),
              _detailReciept('Produk', 'TELKOMSEL 2000'),
              _detailReciept('Deskripsi', 'Telkomsel Reguler Rp 2.000'),
              _detailReciept('Status', 'Berhasil'),
              _detailReciept('SN', '61322132154646545'),
              _detailReciept('Harga', 'Rp 2.800'),
