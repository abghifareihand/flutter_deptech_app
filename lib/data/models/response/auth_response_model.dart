...
class User {
  ...
  final String? profilePicture; // Changed to String?
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        profilePicture: json["profile_picture"], // Handle nullable String
  ...
  Map<String, dynamic> toJson() => {
        ...
        "profile_picture": profilePicture, // Ensure it's properly handled
